...
const DESCRIPTIONS = {
  'reviews.html':
    '대전세븐나이트 실제 방문 후기 1,287건 평점 4.9/5.0. 4인1조 부킹 W.T 원숭이를 통해 다녀가신 분들의 생생한 리뷰. 둔산동 No.1 나이트클럽 검증된 만족도. 예약 .',
  'price.html':
    '대전세븐나이트 가격 안내 - 일반 테이블·코너석·VIP룸별 정찰제 운영. 양주·맥주·안주 구성, 바가지 NO. 4인1조 부킹 우선배정. 정확한 견적은 W.T 원숭이  즉시 상담.',
  'faq.html':
    '대전세븐나이트 자주 묻는 질문 30선. 예약 방법, 4인1조 시스템, 위치, 가격, 영업시간, 복장, 주차, 카드결제까지 W.T 원숭이가 직접 답변. 둔산동 No.1 나이트 .',
  'hoesik-2cha.html':
    '대전 회식 2차 어디 갈지 고민이라면 대전세븐나이트가 정답. 둔산동 No.1 나이트클럽 4인1조 부킹, 단체 6~15인 즉시 세팅, VIP룸 분리 가능, 정찰제. W.T 원숭이 .',
  'birthday.html':
    '대전 생일파티 장소는 대전세븐나이트 VIP룸 + 케이크 세팅 + 폭죽 연출. 친구·연인·동기 인생 생일 책임지는 둔산동 No.1 나이트, W.T 원숭이가 사전 준비. 예약 .',
  'first-visit.html':
    '대전 나이트 처음이라면 대전세븐나이트 초보 가이드부터. 입장·복장·부킹·가격까지 처음 방문 5단계 완벽 정리, W.T 원숭이가 입장부터 마무리까지 책임 안내. .',
  'group.html':
    '대전 단체 모임 8~20인은 대전세븐나이트 VIP룸 즉시 세팅. 동창회·MT·송년회·송별회·신년회 책임지는 둔산동 No.1 나이트클럽, 정찰가 단체 견적  W.T 원숭이.'
};
